...
.PHONY: help package desktop verify bundle release
...
help:
	...
	@echo 'make bundle   Create a native .deb, Windows zip, or macOS app zip'
...
package desktop verify bundle release:
