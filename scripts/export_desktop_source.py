...
_FILES = {
    ...
    "docs/desktop-evidence/workbench/blue-overview-light.png",
    "docs/desktop-evidence/workbench/blue-overview-dark.png",
    "docs/desktop-evidence/workbench/blue-composer-light.png",
    "docs/desktop-evidence/workbench/blue-documents-light.png",
    "docs/desktop-evidence/workbench/source-flow-inventory.png",
    "docs/desktop-evidence/workbench/source-flow-facts.png",
    "docs/desktop-evidence/workbench/source-flow-dark.png",
